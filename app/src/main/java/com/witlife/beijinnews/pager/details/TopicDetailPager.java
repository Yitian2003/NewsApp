...
import com.witlife.beijinnews.adapter.TopicDetailPagerAdpter;
...
public class TopicDetailPager extends DetailBasePager {
    ...
    public TopicDetailPager(Context context, NewsCenterPagerBean.DataEntity dataEntity) {
        super(context);
    ...
    public void initData() {
        ...
        tabTopicDetailPagers = new ArrayList<>();
        for (int i = 0; i< children.size(); i++){
            tabTopicDetailPagers.add(new TabTopicDetailPager(context, children.get(i)));
        }

        viewPager.setAdapter(new TopicDetailPagerAdpter(tabTopicDetailPagers));
